...
// console.log([max ,  min]);
    ...
    function drawLegend(canvas) {
        ...
        data.forEach(function (d, i) {
            mounth.append("text")
                .attr('transform','translate('+[x(i) , -20 ]+')')
                .attr("class",'mounthText')
                .text(d.data)
            ;
        })
    ...
    function drawGist(canvas) {
        ...
        data.forEach(function (t , i ) {
            ...
            t.vals.forEach(function (t2, number) {
                ...
                if (( number %2) ==0 ) sss = 0; else  sss = +prop.spaceBar ;
                barRe = bar.append("g").attr("transform", "translate("+[barSize * number +sss ,  reMove]+")") ;
                barRe.append("rect")
                    .attr("width",barSize)
                    .attr("height",reHe)
                    .attr("fill",prop.color[number])
