...
data.forEach(function (t, i ) {
    ...
    propgress.append("rect")
        ...
        .on("mousemove", function() {
            ...
            div.html(   "План :  " + currencySwapNoCut(Object.values(t)[0][1] ) )
    ...
    propgress.append("rect")
        ...
        .on("mousemove", function() {
            div.transition().duration(200).style("opacity", .9);
            div.html(   "Исполнено :  " + currencySwapNoCut(Object.values(t)[0][0] ) )
                .style("left", (d3.event.pageX) + "px")
                .style("top", (d3.event.pageY - 30 ) + "px")
            ;
        })
    ...
    propgress.append("text")
        ...
        .text(currencySwapWithText( Object.values(t) [0][1] ))
    ;



    text = gist.append("g").attr("transform" , "translate("+[ 350+ barSize +50 ,35]+")").attr("class" , "textLegendRight") ;
    text.append("text").html(currencySwapWithText( Object.values(t) [0][1] ));
